...
type VerticalStripTypes =
  | "gray-strip-vertical"
  | "gradient-strip-vertical"
  | "salmon-strip-vertical";

type CreditCardType = NormalTypes | StripTypes | VerticalStripTypes;

// Arrays used for runtime checks:
const STRIP_TYPES: StripTypes[] = [
  "transparent-strip",
  "gray-strip",
  "gradient-strip",
  "salmon-strip",
...
const VERTICAL_STRIP_TYPES: VerticalStripTypes[] = [
  "gray-strip-vertical",
  "gradient-strip-vertical",
  "salmon-strip-vertical",
];

const CARD_WITH_COLOR_LOGO: NormalTypes[] = [
  "brand-dark",
  "brand-light",
  "gray-dark",
  "gray-light",
